...
namespace Rover.Implementations.Orientations
{
    public class North : IPosition
    {
        ...
        public North(int x, int y, int maxX, int maxY)
        {
            this._x = x;
            this._y = y;
            this._maxX = maxX;
        ...
        public IPosition Move(Command instruction)
        {
            ...
            else if (instruction == Command.F && this._maxY != this._y)
                this._y++;
            else if (instruction == Command.B && this._y != 0)
                this._y--;
